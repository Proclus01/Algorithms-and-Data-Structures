...
function minSubArrayLen(nums, sum) {
    ...
    while (start < nums.length) {
        ...
        // If current window adds up to at least the the sum given
        ...
        // If curent total is less than required total but we reach the end,
        // then we need to break or else we'll be in an infinite loop
        else {
            break;
        }
    }
